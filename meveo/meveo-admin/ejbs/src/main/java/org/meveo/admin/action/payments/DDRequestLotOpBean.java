...
/**
 * Standard backing bean for {@link DDRequestLotOp} (extends {@link BaseBean}
...
public class DDRequestLotOpBean extends BaseBean<DDRequestLotOp> {
    ...
    /**
     * Injected @{link DDRequestLotOp} service. Extends
     ...
     */
    @Factory("ddrequestLotOp")
    @Begin(nested = true)
    public DDRequestLotOp init() {
        return initEntity();
    }
     ...
     */
    @Out(value = "ddrequestLotOps", required = false)
    protected PaginationDataModel<DDRequestLotOp> getDataModel() {
        return entities;
    }
