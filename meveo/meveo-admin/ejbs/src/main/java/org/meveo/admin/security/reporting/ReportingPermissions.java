...
@Identifier(name = "reporting", value = ClassIdentifierStrategy.class)
@Permissions( { @Permission(action = "reportingVisualization"), @Permission(action = "reportingManagement") })
@Startup
