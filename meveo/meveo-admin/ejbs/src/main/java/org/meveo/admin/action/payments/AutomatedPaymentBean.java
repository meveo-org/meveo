...
public class AutomatedPaymentBean extends BaseBean<AutomatedPayment> {
     ...
     */
    @In
    private AutomatedPaymentServiceLocal automatedPaymentService;
     ...
     */
    @Out(value = "automatedPayments", required = false)
    protected PaginationDataModel<AutomatedPayment> getDataModel() {
        return entities;
    }
