...
public class BillingCycleBean extends BaseBean<BillingCycle> {
     ...
     */
    @Out(value = "billingCycles", required = false)
    protected PaginationDataModel<BillingCycle> getDataModel() {
        return entities;
    }
