...
/**
 * Information about inputs Vertina received and processed.
 * 
 * @author Ignas Lelys
 * @created Apr 20, 2010
 * 
 */
@Entity
@DiscriminatorValue("VERTINA")
public class VertinaInputHistory extends InputHistory {

    private static final long serialVersionUID = 1L;

    public VertinaInputHistory() {
    }

    /**
     * Convert from {@link InputHistory} to {@link VertinaInputHistory}.
     * 
     * @param inputInfo
     *            {@link InputHistory} superclass.
     */
    public VertinaInputHistory(InputHistory inputInfo) {
