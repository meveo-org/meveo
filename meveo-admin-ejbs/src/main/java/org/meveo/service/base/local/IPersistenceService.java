...
public interface IPersistenceService<E extends IEntity> {
	...
	/**
	 * Load and return the list of the entities from database according to sorting
	 * and paging information in {@link PaginationConfiguration} object.
	 * 
	...
	/**
	 * Refresh entity with state from database, or if it is not managed - retrieve
	 * it freshly from DB.
	 * 
	...
	/**
	 * If entity is not managed - retrieve it freshly from DB. If entity is managed
	 * - return as is.
	 * 
	...
	/**
	 * This method is implemented in business service
	 * 
	 * @param code code of the business entity
