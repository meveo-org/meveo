...
public class JsonSetType implements UserType, DynamicParameterizedType {
    ...
    public void setParameterValues(Properties parameters) {
        try {
            ...
            if(property != null){
                try{
                    ParameterizedType setType = (ParameterizedType) property.getGenericType();
                    Class<?> setClass = (Class<?>) setType.getActualTypeArguments()[0];
                    valueType = OBJECT_MAPPER.getTypeFactory().constructCollectionType(HashSet.class, setClass);
                }catch (ClassCastException e){
                    valueType = OBJECT_MAPPER.getTypeFactory().constructCollectionType(HashSet.class, Object.class);
                }
                classType = Set.class;
            }
