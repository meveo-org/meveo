...
public class BeforeDBTest {
    ...
    public void setUp() throws Exception {
        ...
        params.put(DB_URL, "jdbc:hsqldb:mem:core");
        params.put(DB_HBM2DDL, "create-drop");
        params.put(DB_DRIVER_CLASS, "org.hsqldb.jdbcDriver");
        params.put(DB_SHOW_SQL, "false");
        MeveoPersistence.init("CorePU", params);

        IDatabaseTester tester = new JdbcDatabaseTester("org.hsqldb.jdbcDriver", "jdbc:hsqldb:mem:core", "sa", "");
