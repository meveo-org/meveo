...
public class JacksonUtil {
    ...
    static {
        ...
        om.setVisibility(om.getVisibilityChecker().withFieldVisibility(Visibility.ANY));
        om.setVisibility(om.getVisibilityChecker().withGetterVisibility(Visibility.NONE));
