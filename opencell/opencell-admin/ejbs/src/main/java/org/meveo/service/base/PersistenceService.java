...
public abstract class PersistenceService<E extends IEntity> extends BaseService implements IPersistenceService<E> {
    ...
    /**
     * @see org.meveo.service.base.local.IPersistenceService#findById(Long)
     */
    @Override
    ...
    /**
     * @see org.meveo.service.base.local.IPersistenceService#findById(Long, List)
     */
    @Override
    ...
    /**
     * @see org.meveo.service.base.local.IPersistenceService#findById(Long, List, boolean)
     */
    ...
    /**
     * @see org.meveo.service.base.local.IPersistenceService#disable(Long)
     */
    @Override
    ...
    /**
     * @see org.meveo.service.base.local.IPersistenceService#enable(Long)
     */
    @Override
    ...
    /**
     * @see org.meveo.service.base.local.IPersistenceService#remove(Long)
     */
    @Override
    ...
    /**
     * @see org.meveo.service.base.local.IPersistenceService#remove(Set)
     */
    @Override
    ...
    /**
     * @see org.meveo.service.base.local.IPersistenceService#refreshOrRetrieve(List)
     */
    @Override
    ...
    /**
     * @see org.meveo.service.base.local.IPersistenceService#retrieveIfNotManaged(List)
     */
    @Override
