...
public class CustomFieldMatrixColumnDto extends BaseEntityDto {
	...
	@ApiModelProperty(required = true, value = "The column use")
	private CustomFieldColumnUseEnum columnUse = CustomFieldColumnUseEnum.USE_KEY;

	/** The position. */
	@XmlAttribute(required = true)
	@ApiModelProperty(required = true, value = "Display position")
	private int position;

	/** The code. */
	@XmlAttribute(required = true)
	@Size(max = 20)
	@ApiModelProperty(value = "Unique field for this entity", required = true)
	private String code;

	/** The label. */
	@XmlAttribute(required = true)
	@Size(max = 50)
	@ApiModelProperty(required = true, value = "Display label")
	private String label;

	/** The key type. */
	@XmlAttribute(required = true)
	@ApiModelProperty(required = true, value = "Type of key for this matrix")
