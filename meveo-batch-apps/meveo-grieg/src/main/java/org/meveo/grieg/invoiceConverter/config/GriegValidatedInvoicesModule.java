...
import org.meveo.grieg.invoiceConverter.input.ValidatedInvoiceInputLoader;
...
import org.meveo.grieg.invoiceConverter.output.PDFOutputHandler;
import org.meveo.grieg.invoiceConverter.process.InvoiceProcessor;
import org.meveo.grieg.invoiceConverter.task.ValidatedInvoiceProcessorTask;

import com.google.inject.AbstractModule;
import com.google.inject.TypeLiteral;

/**
 * This module creates almost same task as regular one, just it takes xml files
 * from validated invoices dir and output handler handles maileva and not save
 * pdfs to db.
 * 
 * @author Ignas Lelys
 * @created Jan 21, 2011
 * 
 */
public class GriegValidatedInvoicesModule extends AbstractModule {

    @Override
    protected void configure() {
        bind(TaskLauncher.class).to(SimpleTaskLauncher.class);
        bind(MeveoTask.class).to(ValidatedInvoiceProcessorTask.class);
        ...
        bind(InputLoader.class).to(ValidatedInvoiceInputLoader.class);
        ...
        bind(OutputHandler.class).to(PDFOutputHandler.class);
