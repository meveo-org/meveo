 ...
 * @created 18 mars 11
 */
public class ValidatedDunningInputLoader extends SimpleFileInputLoader {
    ...
    public File getFileForProcessing() {
        return FileUtils.getFileForParsing(config.getValidatedDunningFilesDirectory(), config
                .getDunningFileExtensions());
    }
