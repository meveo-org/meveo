...
public class BeforeDBTest {
    ...
    public void setUp() throws Exception {
        ...
        IDatabaseTester tester = new JdbcDatabaseTester("org.hsqldb.jdbcDriver", "jdbc:hsqldb:mem:medina", "sa",
                "");
        tester.setDataSet(new FlatXmlDataSet(new File("test/test-data.xml")));
