...
public class MavenClassLoader extends URLClassLoader {
	...
	/**
	 * Remove a maven dependency from the class loader
	 * 
	 * @param dependency The maven dependency to be removed
	 */
	public synchronized void removeLibrary(MavenDependency dependency) {
