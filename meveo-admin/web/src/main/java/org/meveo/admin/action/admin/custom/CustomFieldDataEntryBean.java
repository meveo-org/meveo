...
public class CustomFieldDataEntryBean implements Serializable {
	...
	//
	// /**
	// * Load available custom fields (templates) and their values for a given
	// entity
	// *
	// * @param entity Entity to load definitions and field values for
	// * @param cfisAsMap Custom field instances mapped by a CFT code
	// */
	// private void initFields(ICustomFieldEntity entity, Map<String,
	// List<CustomFieldInstance>> cfisAsMap) {
	//
	// Map<String, CustomFieldTemplate> customFieldTemplates =
	// customFieldTemplateService.findByAppliesTo(entity);
	// log.debug("Found {} custom field templates for entity {}",
	// customFieldTemplates.size(), entity.getClass());
	//
	// GroupedCustomField groupedCustomField = new
	// GroupedCustomField(customFieldTemplates.values(), "Custom fields", false);
	// groupedFieldTemplates.put(entity.getUuid(), groupedCustomField);
	//
	// CustomFieldValueHolder entityFieldsValues = new
	// CustomFieldValueHolder(customFieldTemplates, cfisAsMap, entity);
	// fieldsValues.put(entity.getUuid(), entityFieldsValues);
	// }

	// /**
	// * Load available custom fields (templates) for a given child entity field
	// definition
	// *
	// * @param childEntityFieldDefinition Custom field template of child entity
	// type, definition
	// */
	// private void initGroupedCustomFieldsForChildEntity(CustomFieldTemplate
	// childEntityFieldDefinition) {
	//
	// Map<String, CustomFieldTemplate> customFieldTemplates =
	// customFieldTemplateService.findByAppliesTo(
	// EntityCustomizationUtils.getAppliesTo(CustomEntityTemplate.class,
	// CustomFieldTemplate.retrieveCetCode(childEntityFieldDefinition.getEntityClazz())));
	//
	// log.debug("Found {} custom field templates for entity {}",
	// customFieldTemplates.size(), childEntityFieldDefinition.getEntityClazz());
	//
	// GroupedCustomField groupedCustomField = new
	// GroupedCustomField(customFieldTemplates.values(), "Custom fields", false);
	// groupedFieldTemplates.put(childEntityFieldDefinition.getEntityClazz(),
	// groupedCustomField);
	// }
